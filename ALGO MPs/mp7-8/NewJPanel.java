...
public class NewJPanel extends javax.swing.JPanel {
     ...
     */
    public Color nodeColor = new Color(232, 124, 93); //orange
    public Color nodeBorder = new Color(217, 187, 112); //yellow
    public Color HighLight = new Color(216, 75, 89); //red
    public Color LineFont = new Color(245, 245, 221);
    ...
    private void initComponents() {
       ...
       Timer animate = new Timer(2,new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent ae) {
           if(NodeAnime.radius < 50){
               //System.out.println("R for time "+NodeAnime.radius);
               NodeAnime.radius+=5;
   ...
   for(int i=0;i<NewJPanel.lines.size();i++){
      ...
      repaint();
            ...
            System.err.println("Click Again"); 
        }
    ...
    public void inputWeight(Line line){
        JFrame frame  = new JFrame();
         ...
         String s = (String)  JOptionPane.showInputDialog(frame,"Enter value of the path","Input",
